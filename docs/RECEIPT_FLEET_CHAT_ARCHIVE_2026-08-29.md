...
|---|---|
| GitHub docs publication | The final docs ref is local `42457cc8eba6b8cda7a50f597d6670a28089e47d`, published through the Git-data workflow as owned-fork commit `5fc48e9f07a15cbdf482a212df75b83268a2b7a6`; tree `a259691e74a7ca2b08efd2e17ca38eca0b6d6f22`, parent `e25458991eac2ccdd6ef7572e186857a7991679f`, `force=false`. Recursive readback matched all 34 local blobs by path, mode, type, and SHA; upstream was untouched. The content reconciliation commit was `92bc5fcf35212b96484b98e0a6dd54e28d83fb8f`. |
